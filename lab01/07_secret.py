...
# Нужно его расшифровать и вывести на консоль в удобночитаемом виде.
...
help = secret_message[2][5:14]
ans = secret_message[0][3] + ' ' +secret_message[1][9:13] + ' ' +help[::2] + ' ' +secret_message[3][-20:6:-1]+ ' ' +secret_message[4][-12:15:-1]
print (ans)
